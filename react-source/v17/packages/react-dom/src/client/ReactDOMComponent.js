...
import {sabyError} from 'shared/sabyError';
import {
...
if (__DEV__) {
  ...
  warnForTextDifference = function(
    ...
    sabyError('hydration error! Text content did not match. Server: "%s" Client: "%s"',
  ...
  warnForPropDifference = function(
    ...
    didWarnInvalidHydration = true;
    sabyError('hydration error! Prop `%s` did not match. Server: %s Client: %s',
      propName,
...
export function warnForDeletedHydratableElement(
  ...
  if (__DEV__) {
    ...
    didWarnInvalidHydration = true;
    sabyError('hydration error! Did not expect server HTML to contain a <%s> in <%s>.',
...
export function warnForDeletedHydratableText(
  ...
  if (__DEV__) {
    ...
    didWarnInvalidHydration = true;
    sabyError('hydration error! Did not expect server HTML to contain the text node "%s" in <%s>.',
      child.nodeValue,
      parentNode.nodeName.toLowerCase(),
    );
  }
...
export function warnForInsertedHydratedElement(
  ...
  if (__DEV__) {
    ...
    didWarnInvalidHydration = true;
    sabyError('hydration error! Expected server HTML to contain a matching <%s> in <%s>.',
      tag,
      parentNode.nodeName.toLowerCase(),
    );
  }
...
export function warnForInsertedHydratedText(
  ...
  if (__DEV__) {
    ...
    didWarnInvalidHydration = true;
    sabyError('hydration error! Expected server HTML to contain a matching text node for "%s" in <%s>.',
      text,
      parentNode.nodeName.toLowerCase(),
    );
  }
