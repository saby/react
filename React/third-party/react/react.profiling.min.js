...
b)};c.useImperativeHandle=function(a,b,c){return f().useImperativeHandle(a,b,c)};c.useLayoutEffect=function(a,b){return f().useLayoutEffect(a,b)};c.useMemo=function(a,b){return f().useMemo(a,b)};c.useMutableSource=O;c.useReducer=function(a,b,c){return f().useReducer(a,b,c)};c.useRef=function(a){return f().useRef(a)};c.useState=function(a){return f().useState(a)};c.useTransition=M;c.version="17.0.1"});
