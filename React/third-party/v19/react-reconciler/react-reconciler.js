define('react-reconciler', ['react'], (function (require$$0) { 'use strict';
		...
		module.exports = function ($$$config) {
		  ...
		  function updateReducerImpl(hook, current, reducer) {
		    ...
		    if (null === baseQueue) hook.memoizedState = pendingQueue;
		      ...
		      var newBaseQueueFirst = (baseFirst = null),
		        ...
		        update = current,
		        didReadFromEntangledAsyncAction$51 = false;
		      do {
		        ...
		        if (
		          ...
		          if (0 === revertLane)
		            null !== newBaseQueueLast &&
		              ...
		              updateLane === currentEntangledLane &&
		                (didReadFromEntangledAsyncAction$51 = true);
		        ...
		        if (5 === node$85.tag) {
		          ...
		          if (22 === node$85.tag && null !== node$85.memoizedState)
		            (instance = node$85.child),
		              ...
		              appendAllChildren(parent, node$85, true, true);
		      ...
		      if (
		        ...
		        oldProps$88 === currentInstance
		          ...
		          : (markCloned(workInProgress),
		            ...
		            current && appendAllChildren(oldProps$88, workInProgress, false, false));
		      ...
		      case 5:
		        ...
		        if (null !== current && null != workInProgress.stateNode)
		          ...
		          if (popHydrationState(workInProgress))
		            ...
		            markCloned(workInProgress);
		            appendAllChildren(instance$101, workInProgress, false, false);
		        ...
		        if (current && null != workInProgress.stateNode)
		          ...
		          if (popHydrationState(workInProgress)) {
		            ...
		            hydrateTextInstance(
		              ...
		              workInProgress,
		              newProps
		            ) || throwOnHydrationMismatch(workInProgress, true);
		          } else
		            markCloned(workInProgress),
		              (workInProgress.stateNode = createTextInstance(
		                newProps,
		  ...
		  var classComponentUpdater = {
		    ...
		    DefaultAsyncDispatcher = {
			  ...
			  // TODO: костыль чтобы отладка пикси хоть как-то работал			  
			  getOwner: function () {
				return null;
			  }
		    },
		  ...
		  exports$1.createContainer = function (
		    containerInfo,
		    tag,
		    hydrationCallbacks,
		    isStrictMode,
		  ...
		  exports$1.createHydrationContainer = function (
		    initialChildren,
		    callback,
		    containerInfo,
		    tag,
		  ...
		  exports$1.observeVisibleRects = function (
		    hostRoot,
		    selectors,
		    callback,
		    options
		  ...
		  exports$1.startHostTransition = function (
		    formFiber,
		    pendingState,
		    action,
		    formData
		  ...
		  exports$1.updateContainer = function (
		    element,
		    container,
		    parentComponent,
		    callback
		  ...
		  exports$1.updateContainerSync = function (
		    element,
		    container,
		    parentComponent,
		    callback
	...
	var ReconcilerNS = /*#__PURE__*/_mergeNamespaces({
		__proto__: null,
		default: index
	}, [reactReconcilerExports]);

	// src/reconciler-entry.js

	const defaultExport = index || ReconcilerNS;

	return defaultExport;

}));
//# sourceMappingURL=react-reconciler-pixi.js.map
