define("react-dom/server.node", ['exports', 'util', 'crypto', 'async_hooks', 'react', 'react-dom', 'stream'], (function (exports, util, crypto, async_hooks, React, ReactDOM, stream) { 'use strict';
  ...
  var reactDOMPackageVersion = '19.2.3';
  ...
  function resumeAndPrerenderToNodeStream(children, postponedState, options) {
    return new Promise((resolve, reject) => {
      ...
      const request = resumeAndPrerenderRequest(children, postponedState, resumeRenderState(postponedState.resumableState, undefined), options ? options.onError : undefined, onAllReady, undefined, undefined, onFatalError, options ? options.onPostpone : undefined);
      if (options && options.signal) {
        const signal = options.signal;
        if (signal.aborted) {
          abort(request, signal.reason);
