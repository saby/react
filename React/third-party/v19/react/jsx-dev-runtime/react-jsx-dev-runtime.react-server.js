define("react/jsx-dev-runtime/react-server", ['exports', 'react'], (function (exports, React) { 'use strict';
  ...
  function getOwner() {
    {
      const dispatcher = ReactSharedInternalsServer.A;
      if (dispatcher === null) {
        return null;
      }
  ...
  function jsxProdSignatureRunningInDevWithDynamicChildren(type, config, maybeKey) {
    {
      ...
      const trackActualOwner = ReactSharedInternalsServer.recentlyCreatedOwnerStacks++ < ownerStackLimit;
  ...
  const jsx = jsxProdSignatureRunningInDevWithDynamicChildren ;
  // we may want to special case jsxs internally to take advantage of static children.
  // for now we can ship identical prod functions
  const jsxs = jsxProdSignatureRunningInDevWithStaticChildren ;
  const jsxDEV = jsxDEV$1 ;
