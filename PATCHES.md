...
```
Сейчас не собираем react-reconciler для v19 
Текущая версия собрана из node-modules
Это связанно с тем что результат из исходников и из npm при сборке отличается
а для pixi-react важно что за reconciler собран, с собранной версией из исходников оно не работает 
```
