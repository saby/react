...
async function createBundle(bundle, bundleType) {
  ...
  const rollupConfig = {
    input: require.resolve(bundle.entry),
    treeshake: {
    ...
    output: {
      file: Packaging.getBundleOutputPath(bundle, bundleType, filename, packageName),
      format: format,
...
async function buildEverything() {
  ...
  bundles = bundles.filter(([bundle, bundleType]) => !shouldSkipBundle(bundle, bundleType));
