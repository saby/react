...
const REACT_ROOT = path.join(ROOT, 'react-source', 'v19');
...
const REACT_TEST_RENDERER_SOURCE_PATH = path.join(REACT_ROOT, 'packages', 'react-test-renderer');
...
const REACT_TEST_RENDERER_OUT_PATH = path.join(REACT_BUILD_AMD_PATH, 'react-test-renderer');
...
const THIRD_PARTY_PATH = path.join(ROOT, 'React', 'third-party', 'v19');
const PREBUILD_PATH = path.join(PROJECT_ROOT, 'v19', 'third-party', 'prebuild');
...
module.exports = {
  ...
  AMD_CUSTOM_FILES,
  STRUCTURE_MAP,
  REACT_TEST_RENDERER_SOURCE_PATH,
  REACT_TEST_RENDERER_OUT_PATH
};
